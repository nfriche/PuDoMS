...
def download(url, localName):
    ...
    req = urllib.request.Request(url)  # Updated urllib2 to urllib.request
    r = urllib.request.urlopen(req)  # Updated urllib2 to urllib.request
...
def process(csv_file, output_dir):
    ...
    with open(csv_file, "r") as f:
        ...
        for fields in file_reader:
            id = fields[0]
            url = fields[4]
            print("Downloading:", id, url)  # Updated print statement
            try:
